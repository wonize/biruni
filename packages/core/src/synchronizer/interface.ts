...
export interface Synchronizer<Data extends StoreData> {
	addListener<Event extends EventName, Keys extends KeyDiff<Data>, Diffs extends DataDiff<Data, Keys>>(payload: {
		$$event: Event,
		$$listener: ListenerFunction<Data, NoInfer<Event>, Keys, Diffs>
	}): void;

	removeListener<Event extends EventName, Keys extends KeyDiff<Data>, Diffs extends DataDiff<Data, Keys>>(payload: {
		$$event: Event,
		$$listener: ListenerFunction<Data, NoInfer<Event>, Keys, Diffs>
	}): void;
