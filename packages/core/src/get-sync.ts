...
interface KeyMapper<Data extends StoreData> {
	<Key extends keyof Data, Mapper extends SingleKeyMapperFunction<Data, Key>>(key: Key, mapper: Mapper): KeyMapperReturnType<Data, Key, Mapper>;
}
...
interface TruthyKeys<Data extends StoreData> {
	<KeyObject extends Record<keyof Data, boolean>>(keys: Partial<KeyObject>): TruthyKeysReturnType<Data, KeyObject>;
}
