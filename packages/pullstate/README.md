...
```sh
$ npm install --save @biruni/pullstate pullstate
```

### yarn :

```sh
$ yarn add @biruni/pullstate pullstate
```

### pnpm :

```sh
$ pnpm add --save @biruni/pullstate pullstate
```

### Bun :

```sh
$ bun add @biruni/pullstate pullstate
```
...
[REPO]: https://github.com/wonize/biruni/tree/main/packages/pullstate
[HOMEPAGE]: https://wonize.github.io/biruni/plugin/pullstate/
