...
```sh
$ npm install --save @biruni/zustand zustand
```

### yarn :

```sh
$ yarn add @biruni/zustand zustand
```

### pnpm :

```sh
$ pnpm add --save @biruni/zustand zustand
```

### Bun :

```sh
$ bun add @biruni/zustand zustand
```
...
[REPO]: https://github.com/wonize/biruni/tree/main/packages/zustand
[HOMEPAGE]: https://wonize.github.io/biruni/plugin/zustand/
