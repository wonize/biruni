...
class DropDown extends React.Component<
	{ options: Record<string, React.JSX.Element> },
...
> {
	...
	render(): React.ReactNode {
		return (
			<div className="App">
				<div className="example-output">{this.props.options[this.state.value]}</div>
				<div
	...
	static Option = (props: any) => {
		return (
			<li className="example-option" onClick={() => props.setter(props.value)}>
				{props.value}
			</li>
		);
	};
